...
function isValid(contents)
	...
	if string.sub(contents, je, je) == searchChar then
		...
		local arrayCheckBool = arrayCheck(string.sub(contents, js, je))
		local listCheckBool = listCheck(string.sub(contents, js, je))


		local checkBool = arrayCheckBool or listCheckBool
		if checkBool then
